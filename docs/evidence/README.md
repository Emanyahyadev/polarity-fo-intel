...
| `dataset-discovery-report.json` | pipeline | 398 discovered → 189 qualified → 68 released → 61 delivered, with rejection reasons |
...
| `live-url-query-transcript.json` + `.md` | deployment | live URL verified — `/health` = 61 records + 6 real queries (4 answered with grounded records, 2 correct abstentions) |

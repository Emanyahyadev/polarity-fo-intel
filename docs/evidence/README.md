...
| `rag-abstention-eval.json` + `.md` | RAG eval | grounding/abstention 18/18 on labelled queries incl. adversarial in-vocabulary probes ("pizza office", "office space", "family offices on the moon") |

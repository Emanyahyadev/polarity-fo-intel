...
- expected: answer · got: answer · ✓ · mode=extractive · top similarity 0.79
- Found 5 matching family offices in the verified dataset:

## Q: family offices in New York
- expected: answer · got: answer · ✓ · mode=extractive · top similarity 0.74
- Found 5 matching family offices in the verified dataset:
...
- expected: ABSTAIN · got: ABSTAIN · ✓ · mode=abstain · best match similarity 0.56 is below the 0.68 threshold
- I don't have enough verified information to answer that from this dataset. This service only answers from a validated set of family-office records; try naming a family-office type (single- or multi-family), a US state, an investing focus, or a firm name.
...
- expected: ABSTAIN · got: ABSTAIN · ✓ · mode=abstain · best match similarity 0.60 is below the 0.68 threshold
- I don't have enough verified information to answer that from this dataset. This service only answers from a validated set of family-office records; try naming a family-office type (single- or multi-family), a US state, an investing focus, or a firm name.

## Q: family offices headquartered on the moon
- expected: ABSTAIN · got: ABSTAIN · ✓ · mode=abstain · best match similarity 0.64 is below the 0.68 threshold
- I don't have enough verified information to answer that from this dataset. This service only answers from a validated set of family-office records; try naming a family-office type (single- or multi-family), a US state, an investing focus, or a firm name.
